// UT_DigitSearch_Annex_3_DY.h

#ifndef _UT_DIGIT_SEARCH_ANNEX_3_DY_H_
#define _UT_DIGIT_SEARCH_ANNEX_3_DY_H_
...
class UT_DigitSearch_Annex_3_DY // Dynamic
{
private:
...
#endif // _UT_DIGIT_SEARCH_ANNEX_3_DY_H_